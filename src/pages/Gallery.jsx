        ...
        <div className="w-full h-auto bg-white md:px-10 px-2 mt-10">
            ...
            <div className="w-full h-auto flex flex-col my-10 md:flex-row">
                <div className="w-full h-auto flex md:w-[50%] lg:w-[40%]">
                    <img src={selectedImage} alt="selected images" className="w-40 mx-auto md:w-80" />
                </div>
                {/* Carousel Section */}
                <div className="flex flex-col items-center justify-center py-10 ml-auto w-full md:w-[48%]">
                    <div className="relative flex items-center justify-center w-full">
                        ...
                        <button
                            onClick={prevSlide}
                            className="absolute left-0 md:-left-14 text-gray-400 p-2 cursor-pointer rounded-full z-10"
                        >
                        ...
                        <button
                            onClick={nextSlide}
                            className="absolute right-0 md:-right-10 text-gray-400 p-2 rounded-full cursor-pointer z-10"
                        >
